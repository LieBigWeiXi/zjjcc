...
public class MediaController extends FrameLayout{
  ...
  private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
    ...
    public void onStopTrackingTouch(SeekBar bar) {
      ...
      doPauseResume();
      mPlayer.seekTo(sDefaultTimeout);
      show(sDefaultTimeout);
      videoView.start();
    }
  };
  ...
  public MediaController(Context context,VideoView videoView, Activity activity) {
    super(context);
  ...
  private void initControllerView(View v) {
    ...
    mRestartButton=(Button)v.findViewById(getResources().getIdentifier("mediacontroller_restart", "id", mContext.getPackageName()));
    ...
    mReturnButton=(Button)v.findViewById(getResources().getIdentifier("mediacontroller_return", "id", mContext.getPackageName()));
